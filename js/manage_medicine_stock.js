...
function searchMedicineStock(text, tag) {
  if(tag == "NAME" || tag == "GENERIC_NAME" || tag == "SUPPLIER_NAME") {
    document.getElementById("by_name").value = tag == "NAME" ? text : "";
    document.getElementById("by_generic_name").value = tag == "GENERIC_NAME" ? text : "";
    document.getElementById("by_suppliers_name").value = tag == "SUPPLIER_NAME" ? text : "";
  }
  else if(tag == "QUANTITY" || tag == "EXPIRY_DATE") {
